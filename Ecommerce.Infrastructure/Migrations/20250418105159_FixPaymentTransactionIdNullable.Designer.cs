...
namespace Ecommerce.Infrastructure.Migrations
{
    ...
    [Migration("20250418105159_FixPaymentTransactionIdNullable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Core.Models.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Ecommerce.Core.Models.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Ecommerce.Core.Models.Entities.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Ecommerce.Core.Models.Entities.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ecommerce.Core.Models.Entities.MenuConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ecommerce.Core.Models.Entities.PaymentTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ecommerce.Core.Models.Entities.CartItem", b =>
                {
                    b.HasOne("Ecommerce.Core.Models.Entities.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Ecommerce.Core.Models.Entities.Customer", b =>
                {
                    b.HasOne("Ecommerce.Core.Models.Entities.ApplicationUser", "User")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("Ecommerce.Core.Models.Entities.MenuConfig", b =>
                {
                    ...
                    b.HasOne("Ecommerce.Core.Models.Entities.MenuConfig", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Ecommerce.Core.Models.Entities.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Ecommerce.Core.Models.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
